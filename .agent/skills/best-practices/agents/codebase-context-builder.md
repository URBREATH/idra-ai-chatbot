...
description: >-
  ...
  <commentary>
  The agent explores app/auth/, finds session handling patterns, discovers
...
- `app/path/to/main.ts` — [what it does, why relevant]
- `app/path/to/related.ts:42` — [specific function/class]
...
- "check `app/specific/path/` for existing patterns"
...
- **Be specific**: `app/auth/login.ts:42` not "the auth module"
